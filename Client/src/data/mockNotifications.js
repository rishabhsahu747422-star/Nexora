export const MOCK_NOTIFICATIONS = [
  {
    ...
    message: 'Dr. Elena Rostova mentioned you in Synthetix AI Lab: "Phenomenal work @rishandev..."',
    timestamp: '15m ago',
    read: false,
  ...
  },
  {
    ...
    message: 'Liam Sterling replied: "Did the multi-hop reasoning hold up on the GSM8k benchmarks?"',
    timestamp: '1h ago',
    read: false,
    link: '/app/server/srv_synthetix/channel/chn_syn_gen',
  ...
  },
  {
    ...
    message: 'Chloe Monet sent you a connection request.',
    timestamp: '2h ago',
    read: false,
    link: '/app/messages',
